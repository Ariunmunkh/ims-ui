...
import { Table, Modal, Drawer, Space, Form, Button, Input, DatePicker, Divider, Select, InputNumber, Typography, } from "antd";
...
export default function Investment() {
    ...
    const fetchData = useCallback(() => {
        ...
        api.get(`/api/record/coach/get_investment_list?coachid=${coachid}`)
            .then((res) => {
