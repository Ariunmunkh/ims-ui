...
const { confirm } = Modal;
export default function IntermediaryOrganization() {

    const [griddata, setGridData] = useState();
    const [loading, setLoading] = useState(true);
    const [formtitle] = useState('Холбон зуучилсан байгууллагын нэр');
    const [formtype] = useState('intermediaryorganization');
